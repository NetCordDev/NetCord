...
public static class ComponentInteractionServiceHostBuilderExtensions
{
    ...
    public static IHostBuilder ConfigureComponentInteractions(this IHostBuilder builder,
    ...
    public static IHostBuilder ConfigureComponentInteractions<TInteraction, TContext>(this IHostBuilder builder,
