...
public partial class RestClient
{
    ...
    [GenerateAlias(typeof(RestGuild), nameof(RestGuild.Id), TypeNameOverride = nameof(Guild))]
    public async Task<IReadOnlyDictionary<ulong, Role>> GetGuildRolesAsync(ulong guildId, RequestProperties? properties = null)
    ...
    [GenerateAlias(typeof(RestGuild), nameof(RestGuild.Id), TypeNameOverride = nameof(Guild))]
    public async Task<Role> CreateGuildRoleAsync(ulong guildId, RoleProperties guildRoleProperties, RequestProperties? properties = null)
    {
    ...
    [GenerateAlias(typeof(RestGuild), nameof(RestGuild.Id), TypeNameOverride = nameof(Guild))]
    public async Task<IReadOnlyDictionary<ulong, Role>> ModifyGuildRolePositionsAsync(ulong guildId, IEnumerable<RolePositionProperties> positions, RequestProperties? properties = null)
    {
    ...
    public async Task<Role> ModifyGuildRoleAsync(ulong guildId, ulong roleId, Action<RoleOptions> action, RequestProperties? properties = null)
    {
        RoleOptions obj = new();
        action(obj);
