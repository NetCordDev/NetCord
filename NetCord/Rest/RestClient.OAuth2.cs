...
{
    public async Task<CurrentApplication> GetCurrentBotApplicationInformationAsync(RestRequestProperties? properties = null)
    ...
    public async Task<AuthorizationInformation> GetCurrentAuthorizationInformationAsync(RestRequestProperties? properties = null)
