...
internal class PaginationAsyncEnumerable<T, TFrom> : IAsyncEnumerable<T> where TFrom : struct
{
    public PaginationAsyncEnumerable(
        RestClient client,
    ...
    private readonly Func<Stream, Task<IEnumerable<T>>> _convertAsync;
