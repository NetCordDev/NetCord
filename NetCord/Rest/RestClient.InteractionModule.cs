...
public partial class RestClient
{
    public class InteractionModule
    {
        ...
        public Task EndAsync(DiscordId interactionId, string interactionToken, RequestOptions? options = null)
        {
            ...
            return _client.SendRequestAsync(HttpMethod.Post, callback.Build(), $"/interactions/{interactionId}/{interactionToken}/callback", options);
        }
        ...
        {
            return _client.SendRequestAsync(HttpMethod.Patch, message.Build(), $"/webhooks/{interactionApplicationId}/{interactionToken}/messages/@original", options);
        }
        ...
        {
            return _client.SendRequestAsync(HttpMethod.Patch, message.Build(), $"/webhooks/{interactionApplicationId}/{interactionToken}/messages/{messageId}", options);
        }
    }
}