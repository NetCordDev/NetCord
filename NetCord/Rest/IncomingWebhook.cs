...
public class IncomingWebhook : Webhook
{
    ...
    public Task<WebhookMessage> GetMessageAsync(ulong messageId, RequestProperties? properties = null) => _client.GetWebhookMessageAsync(Id, Token, messageId, properties);
    public Task<WebhookMessage> ModifyMessageAsync(ulong messageId, Action<MessageOptions> action, ulong? threadId = null, RequestProperties? properties = null) => _client.ModifyWebhookMessageAsync(Id, Token, messageId, action, threadId, properties);
