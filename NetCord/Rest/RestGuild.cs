...
public class RestGuild : ClientEntity, IJsonModel<JsonModels.JsonGuild>
{
    ...
    public Task<IReadOnlyDictionary<Snowflake, ApplicationCommandGuildPermissions>> GetApplicationCommandsPermissionsAsync(Snowflake applicationId, RequestProperties? properties = null) => _client.GetApplicationCommandsGuildPermissionsAsync(applicationId, Id, properties);
