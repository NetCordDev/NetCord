...
public partial class RestClient
{
    ...
    public async Task<ApplicationCommand> CreateGlobalApplicationCommandAsync(ulong applicationId, ApplicationCommandProperties applicationCommandProperties, RequestProperties? properties = null)
        => new(await (await SendRequestAsync(HttpMethod.Post, $"/applications/{applicationId}/commands", new(RateLimits.RouteParameter.CreateApplicationCommand), new JsonContent<ApplicationCommandProperties>(applicationCommandProperties, ApplicationCommandProperties.ApplicationCommandPropertiesSerializerContext.WithOptions.ApplicationCommandProperties), properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommand.JsonApplicationCommandSerializerContext.WithOptions.JsonApplicationCommand).ConfigureAwait(false), this);
    ...
    public async Task<ApplicationCommand> GetGlobalApplicationCommandAsync(ulong applicationId, ulong commandId, RequestProperties? properties = null)
        => new(await (await SendRequestAsync(HttpMethod.Get, $"/applications/{applicationId}/commands/{commandId}", properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommand.JsonApplicationCommandSerializerContext.WithOptions.JsonApplicationCommand).ConfigureAwait(false), this);
    ...
    public async Task<GuildApplicationCommand> CreateGuildApplicationCommandAsync(ulong applicationId, ulong guildId, ApplicationCommandProperties applicationCommandProperties, RequestProperties? properties = null)
        => new(await (await SendRequestAsync(HttpMethod.Post, $"/applications/{applicationId}/guilds/{guildId}/commands", new(RateLimits.RouteParameter.CreateApplicationCommand), new JsonContent<ApplicationCommandProperties>(applicationCommandProperties, ApplicationCommandProperties.ApplicationCommandPropertiesSerializerContext.WithOptions.ApplicationCommandProperties), properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommand.JsonApplicationCommandSerializerContext.WithOptions.JsonApplicationCommand).ConfigureAwait(false), this);
    ...
    public async Task<GuildApplicationCommand> GetGuildApplicationCommandAsync(ulong applicationId, ulong guildId, ulong commandId, RequestProperties? properties = null)
        => new(await (await SendRequestAsync(HttpMethod.Get, $"/applications/{applicationId}/guilds/{guildId}/commands/{commandId}", properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommand.JsonApplicationCommandSerializerContext.WithOptions.JsonApplicationCommand).ConfigureAwait(false), this);
    ...
    public async Task<IReadOnlyDictionary<ulong, GuildApplicationCommand>> BulkOverwriteGuildApplicationCommandsAsync(ulong applicationId, ulong guildId, IEnumerable<ApplicationCommandProperties> commands, RequestProperties? properties = null)
        => (await (await SendRequestAsync(HttpMethod.Put, $"/applications/{applicationId}/guilds/{guildId}/commands", new(RateLimits.RouteParameter.BulkOverwriteApplicationCommands), new JsonContent<IEnumerable<ApplicationCommandProperties>>(commands, ApplicationCommandProperties.IEnumerableOfApplicationCommandPropertiesSerializerContext.WithOptions.IEnumerableApplicationCommandProperties), properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommand.JsonApplicationCommandArraySerializerContext.WithOptions.JsonApplicationCommandArray).ConfigureAwait(false)).ToDictionary(c => c.Id, c => new GuildApplicationCommand(c, this));
    ...
    public async Task<ApplicationCommandGuildPermissions> OverwriteApplicationCommandGuildPermissionsAsync(ulong applicationId, ulong guildId, ulong commandId, IEnumerable<ApplicationCommandGuildPermissionProperties> newPermissions, RequestProperties? properties = null)
        => new(await (await SendRequestAsync(HttpMethod.Put, $"/applications/{applicationId}/guilds/{guildId}/commands/{commandId}/permissions", new(RateLimits.RouteParameter.OverwriteApplicationCommandGuildPermissions), new JsonContent<ApplicationCommandGuildPermissionsProperties>(new(newPermissions), ApplicationCommandGuildPermissionsProperties.ApplicationCommandGuildPermissionsPropertiesSerializerContext.WithOptions.ApplicationCommandGuildPermissionsProperties), properties).ConfigureAwait(false)).ToObjectAsync(JsonModels.JsonApplicationCommandGuildPermissions.JsonApplicationCommandGuildPermissionsSerializerContext.WithOptions.JsonApplicationCommandGuildPermissions).ConfigureAwait(false));
}
