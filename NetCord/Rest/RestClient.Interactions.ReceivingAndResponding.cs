...
{
    public async Task SendInteractionResponseAsync(ulong interactionId, string interactionToken, InteractionCallback callback, RestRequestProperties? properties = null)
    {
    ...
    public async Task<RestMessage> GetInteractionResponseAsync(ulong applicationId, string interactionToken, RestRequestProperties? properties = null)
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public async Task<RestMessage> ModifyInteractionResponseAsync(ulong applicationId, string interactionToken, Action<MessageOptions> action, RestRequestProperties? properties = null)
    {
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public Task DeleteInteractionResponseAsync(ulong applicationId, string interactionToken, RestRequestProperties? properties = null)
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public async Task<RestMessage> SendInteractionFollowupMessageAsync(ulong applicationId, string interactionToken, InteractionMessageProperties message, RestRequestProperties? properties = null)
    {
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public async Task<RestMessage> GetInteractionFollowupMessageAsync(ulong applicationId, string interactionToken, ulong messageId, RestRequestProperties? properties = null)
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public async Task<RestMessage> ModifyInteractionFollowupMessageAsync(ulong applicationId, string interactionToken, ulong messageId, Action<MessageOptions> action, RestRequestProperties? properties = null)
    {
        MessageOptions messageOptions = new();
        action(messageOptions);
        using (HttpContent content = messageOptions.Serialize())
    ...
    [GenerateAlias(typeof(Interaction), nameof(Interaction.ApplicationId), nameof(Interaction.Token))]
    public Task DeleteInteractionFollowupMessageAsync(ulong applicationId, string interactionToken, ulong messageId, RestRequestProperties? properties = null)
