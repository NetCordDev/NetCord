...
public partial class RestClient
{
    ...
    public IAsyncEnumerable<RestMessage> GetMessagesAsync(ulong channelId, PaginationProperties<ulong>? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
    ...
    [GenerateAlias([typeof(TextChannel)], nameof(TextChannel.Id))]
    public async Task<IReadOnlyDictionary<ulong, RestMessage>> GetMessagesAroundAsync(ulong channelId, ulong messageId, int? limit = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    ...
    [GenerateAlias([typeof(TextChannel)], nameof(TextChannel.Id))]
    [GenerateAlias([typeof(RestMessage)], nameof(RestMessage.ChannelId), nameof(RestMessage.Id), TypeNameOverride = "Message")]
    public IAsyncEnumerable<User> GetMessageReactionsAsync(ulong channelId, ulong messageId, ReactionEmojiProperties emoji, MessageReactionsPaginationProperties? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
...
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
    ...
    [GenerateAlias([typeof(TextChannel)], nameof(TextChannel.Id))]
    public async Task<IReadOnlyDictionary<ulong, RestMessage>> GetPinnedMessagesAsync(ulong channelId, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    ...
    [GenerateAlias([typeof(GuildThread)], nameof(GuildThread.Id))]
    public IAsyncEnumerable<ThreadUser> GetGuildThreadUsersAsync(ulong threadId, OptionalGuildUsersPaginationProperties? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
        paginationProperties = PaginationProperties<ulong>.PrepareWithDirectionValidation(paginationProperties, PaginationDirection.After, 100);
    ...
    [GenerateAlias([typeof(TextGuildChannel)], nameof(TextGuildChannel.Id))]
    public IAsyncEnumerable<GuildThread> GetPublicArchivedGuildThreadsAsync(ulong channelId, PaginationProperties<DateTimeOffset>? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
    ...
    [GenerateAlias([typeof(TextGuildChannel)], nameof(TextGuildChannel.Id))]
    public IAsyncEnumerable<GuildThread> GetPrivateArchivedGuildThreadsAsync(ulong channelId, PaginationProperties<DateTimeOffset>? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
        paginationProperties = PaginationProperties<DateTimeOffset>.PrepareWithDirectionValidation(paginationProperties, PaginationDirection.Before, 100);
    ...
    [GenerateAlias([typeof(TextGuildChannel)], nameof(TextGuildChannel.Id))]
    public IAsyncEnumerable<GuildThread> GetJoinedPrivateArchivedGuildThreadsAsync(ulong channelId, PaginationProperties<ulong>? paginationProperties = null, RestRequestProperties? properties = null, CancellationToken cancellationToken = default)
    {
