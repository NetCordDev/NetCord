...
{
    /// <inheritdoc cref="MessagePoll.Question"/>
    [JsonPropertyName("question")]
    public MessagePollMediaProperties Question { get; set; } = question;

    /// <summary>
    /// The set of answers available in the poll, up to 10.
    /// </summary>
    [JsonPropertyName("answers")]
    public IEnumerable<MessagePollAnswerProperties> Answers { get; set; } = answers;

    /// <summary>
    /// The number of hours the poll should be open for, up to 32 days. Defaults to 24.
    /// </summary>
