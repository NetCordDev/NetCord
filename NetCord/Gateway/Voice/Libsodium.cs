...
internal static class Libsodium
{
    ...
    internal static extern unsafe int CryptoSecretboxEasy(byte* c, byte* m, ulong mlen, byte* n, byte[] k);
    ...
    internal static extern unsafe int CryptoSecretboxOpenEasy(byte* m, byte* c, ulong clen, byte* n, byte[] k);
}
