...
{
    /// <summary>
    /// The duration of each Opus frame, in milliseconds. Defaults to <see cref="Opus.DefaultFrameDuration"/>. Allowed values are 2.5, 5, 10, 20, 40, 60 and 120 (the last one is only allowed for <see cref="VoiceChannels.Mono"/>).
    /// </summary>
