...
public abstract class EntityMenu : Menu, IJsonModel<JsonEntityMenuComponent>
{
    ...
    private protected static unsafe IReadOnlyList<ulong> GetSelectedValues<T>(JsonEntityMenuComponent jsonModel, delegate*<IEnumerable<ulong>, InteractionResolvedData, T[]> getValues, out T[] values, InteractionResolvedData? resolvedData) where T : IEntity
    {
