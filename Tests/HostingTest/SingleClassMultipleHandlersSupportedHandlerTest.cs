...
public abstract class SingleClassMultipleHandlersSupportedHandlerTest<TTester>(TestContext context) : HandlerTest<TTester>(context) where TTester : ISingleClassMultipleHandlersSupportedHandlerTester
{
