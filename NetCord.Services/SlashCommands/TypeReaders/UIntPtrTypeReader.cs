...
public class UIntPtrTypeReader<TContext> : SlashCommandTypeReader<TContext> where TContext : BaseSlashCommandContext
{
    ...
    public override double? GetMaxValue(SlashCommandParameter<TContext> parameter) => nuint.MaxValue;
