...
{
    private static readonly GatewayClient _client = new(Environment.GetEnvironmentVariable("token")!, TokenType.Bot, new() { Intents = GatewayIntent.All, ConnectionProperties = ConnectionPropertiesProperties.IOS });
